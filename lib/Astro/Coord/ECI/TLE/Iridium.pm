...
# on Sun Sep  2 12:56:50 2018 GMT
...
__PACKAGE__->status( add => 24837, iridium => '-', 'Iridium 12', 'Tumbling' );
...
__PACKAGE__->status( add => 25172, iridium => 'S', 'Iridium 50', '' );
