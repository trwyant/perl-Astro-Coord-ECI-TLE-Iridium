...
# on Thu Oct  4 13:42:42 2018 GMT
...
__PACKAGE__->status( add => 24839, iridium => '-', 'Iridium 10', 'Tumbling' );
...
__PACKAGE__->status( add => 25528, iridium => '-', 'Iridium 86', 'Tumbling' );
