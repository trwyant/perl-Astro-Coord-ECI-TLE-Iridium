...
# on Mon Oct 15 14:03:09 2018 GMT
...
__PACKAGE__->status( add => 24869, iridium => 'D', 'Iridium 15', 'Decayed 2018-10-15 per Kelso and Sladen' );
...
__PACKAGE__->status( add => 25531, iridium => 'S', 'Iridium 83', '' );
__PACKAGE__->status( add => 25577, iridium => '-', 'Iridium 20', 'Tumbling' );
__PACKAGE__->status( add => 25578, iridium => '-', 'Iridium 11', 'Tumbling' );
