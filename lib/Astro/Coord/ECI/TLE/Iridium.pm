...
# on Thu Dec 13 16:32:20 2018 GMT
...
__PACKAGE__->status( add => 24950, iridium => '-', 'Iridium 31', 'Tumbling' );
__PACKAGE__->status( add => 24965, iridium => 'D', 'Iridium 19', 'Decayed 2018-04-07' );
__PACKAGE__->status( add => 24966, iridium => '-', 'Iridium 35', 'Tumbling' );
